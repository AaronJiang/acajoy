<?php defined('IN_TS') or die('Access Denied.'); ?><div class="facebox bbox pd10">
<div class="face">
...
<a class="btn btn-mini" href="javascript:void('0');" onclick="unfollow('<?php echo $strUser['userid'];?>');">取消关注</a>
<?php } else { ?>
...
<li><span class="fs14"><a href="<?php echo tsurl('user','score',array('id'=>$strUser['userid']))?>"><?php echo $strUser['count_score'];?></a></span><br />积分</li>
</ul>
...
<?php if($strUser['userid'] == $TS_USER['user'][userid]) { ?>[<a href="<?php echo tsurl('user','set',array(ts=>base))?>">修改基本信息</a>]<?php } ?>
...
<dl class="obu"><dt><a class="nbg" href="<?php echo tsurl('user','space',array('id'=>$item['userid']))?>" rel="face" uid="<?php echo $item['userid'];?>"><img alt="<?php echo $item['username'];?>" class="m_sub_img" src="<?php echo $item['face'];?>"></a></dt>
...
<dl class="ob"><dt><a href="<?php echo tsurl('group','show',array('id'=>$item['groupid']))?>"><img alt="<?php echo $item['groupname'];?>" class="m_sub_img" src="<?php echo $item['icon_48'];?>" width="48" /></a></dt>
