...
switch($ts){
	...
	case "":
		...
		$url = tsUrl('photo','album',array('page'=>''));
	...
	case "photo":
		...
		$xxx = $new['photo']->find('photo_album',array(
			'albumid'=>$albumid,
		));
		...
		$url = tsUrl('photo','album',array('ts'=>'photo','albumid'=>$albumid,'page'=>''));
	...
	case "edit_do":
		...
		header("Location: ".tsUrl('photo','album',array('ts'=>'photo','albumid'=>$albumid)));
	...
	case "del":
		...
		header("Location: ".tsUrl('photo','album',array('ts'=>'user','userid'=>$userid)));
