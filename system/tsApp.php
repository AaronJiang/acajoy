<?php
/////////////////////////////////////////////////////////////////////////
// AcaJoy中文社区, Copyright (C) 2011 - 2012 AcaJoy.cn //
////////////////////////////////////////////////////////////////////////
...
class tsApp
{
	 ...
	 */
	public function findAll ($table, $conditions = null, $sort = null, $fields = null, 
            $limit = null)
    {
        $where = "";
	...
	public function findCount ($table, $conditions = null)
    {
        ...
        $sql = "SELECT COUNT(*) AS ts_counter FROM " . dbprefix .
                 "{$table} {$where}";
